...
const getDisplayLabelForValue = (
    items,
    search,
    labelProp,
    keyProp,
) => items.find((item) => item[keyProp] === search)[labelProp];
...
export default function ActionDropdown({
    ...
    return (
        <div className="mr-2 pt-2 pt-lg-0 customcommands-action-dropdown">
            <button
                type="button"
            ...
            <div className="dropdown-menu customcommands-dropdown-menu max-height-dropdown">
                {items.map((item) => (
                    <a
